...
select id 'Идентификатор заказа', data_order 'Дата создания заказа', name_buyer 'ФИО заказчика', phone_number 'Контактный телефон', email 'Адрес эл. почты', adress 'Адрес доставки', status 'Статус заказа', data_ship 'Дата отгрузки товара' from store_on_sofa.orders where YEAR(store_on_sofa.orders.data_order)='2020' AND  MONTH(store_on_sofa.orders.data_order) = '11' OR MONTH(store_on_sofa.orders.data_order) = '12'; -- запрос со списком заказов, созданных в ноябре и декабре
select id 'Идентификатор заказа', data_order 'Дата создания заказа', name_buyer 'ФИО заказчика', phone_number 'Контактный телефон', email 'Адрес эл. почты', adress 'Адрес доставки', status 'Статус заказа', data_ship 'Дата отгрузки товара' from store_on_sofa.orders where YEAR(store_on_sofa.orders.data_ship)='2020' AND MONTH(store_on_sofa.orders.data_ship) = '11' OR MONTH(store_on_sofa.orders.data_ship) = '12'; -- запрос со списком заказов, отгруженных в ноябре и декабре
